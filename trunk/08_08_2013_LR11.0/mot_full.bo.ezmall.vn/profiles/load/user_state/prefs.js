...
user_pref("LoadRunner.Global.SidebarWidth", 377);
...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1376016026);
user_pref("app.update.lastUpdateTime.background-update-timer", 1376015054);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1376015598);
user_pref("app.update.lastUpdateTime.microsummary-generator-update-timer", 1375954729);
user_pref("app.update.lastUpdateTime.places-maintenance-timer", 1376015368);
...
user_pref("idle.lastDailyNotification", 1376021228);
