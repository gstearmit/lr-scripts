...
user_pref("LoadRunner.Global.SidebarWidth", 408);
user_pref("LoadRunner.Global.ToolboxY", 0);
user_pref("LoadRunner.RTS.iteration_number", 0);
user_pref("LoadRunner.config.output_dir", "C:\\Users\\LOADRUNNER11\\Desktop\\HPLOADRUNER 11\\Scripts\\ramDom_click_chi_tiet_hon\\");
user_pref("LoadRunner.config.root_dir", "C:\\PROGRA~1\\HP\\LOADRU~1");
user_pref("LoadRunner.config.runlogic_path", "C:\\Users\\LOADRUNNER11\\Desktop\\HPLOADRUNER 11\\Scripts\\ramDom_click_chi_tiet_hon\\\\default.usp");
user_pref("LoadRunner.config.user_dir", "C:\\Users\\LOADRUNNER11\\Desktop\\HPLOADRUNER 11\\Scripts\\ramDom_click_chi_tiet_hon");
...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1375323590);
user_pref("app.update.lastUpdateTime.background-update-timer", 1375323253);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1375323577);
user_pref("app.update.lastUpdateTime.microsummary-generator-update-timer", 1375323729);
user_pref("app.update.lastUpdateTime.places-maintenance-timer", 1375323001);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1375322703);
...
user_pref("idle.lastDailyNotification", 1375325254);
...
user_pref("places.last_vacuum", 1375325254);
