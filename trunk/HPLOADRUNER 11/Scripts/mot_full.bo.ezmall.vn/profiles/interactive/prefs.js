...
user_pref("LoadRunner.Global.SidebarWidth", 400);
user_pref("LoadRunner.Global.ToolboxY", 0);
user_pref("LoadRunner.RTS.iteration_number", 0);
user_pref("LoadRunner.config.output_dir", "C:\\Users\\LOADRUNNER11\\Desktop\\HPLOADRUNER 11\\Scripts\\mot_full.bo.ezmall.vn\\");
user_pref("LoadRunner.config.root_dir", "C:\\PROGRA~1\\HP\\LOADRU~1");
user_pref("LoadRunner.config.runlogic_path", "C:\\Users\\LOADRUNNER11\\Desktop\\HPLOADRUNER 11\\Scripts\\mot_full.bo.ezmall.vn\\\\default.usp");
user_pref("LoadRunner.config.user_dir", "C:\\Users\\LOADRUNNER11\\Desktop\\HPLOADRUNER 11\\Scripts\\mot_full.bo.ezmall.vn");
...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1375669118);
user_pref("app.update.lastUpdateTime.background-update-timer", 1375668907);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1375668705);
user_pref("app.update.lastUpdateTime.microsummary-generator-update-timer", 1375349427);
user_pref("app.update.lastUpdateTime.places-maintenance-timer", 1375668988);
