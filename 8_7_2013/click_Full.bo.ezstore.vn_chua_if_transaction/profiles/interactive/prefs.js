...
user_pref("LoadRunner.config.output_dir", "D:\\SCrtips_8_7_2013\\8_7_2013\\click_Full.bo.ezstore.vn_chua_if_transaction\\");
user_pref("LoadRunner.config.root_dir", "C:\\PROGRA~1\\HP\\LOADRU~1");
user_pref("LoadRunner.config.runlogic_path", "D:\\SCrtips_8_7_2013\\8_7_2013\\click_Full.bo.ezstore.vn_chua_if_transaction\\\\default.usp");
user_pref("LoadRunner.config.user_dir", "D:\\SCrtips_8_7_2013\\8_7_2013\\click_Full.bo.ezstore.vn_chua_if_transaction");
...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1375860642);
user_pref("app.update.lastUpdateTime.background-update-timer", 1375860472);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1375860404);
user_pref("app.update.lastUpdateTime.microsummary-generator-update-timer", 1375349427);
user_pref("app.update.lastUpdateTime.places-maintenance-timer", 1375860369);
...
user_pref("idle.lastDailyNotification", 1375860786);
